...
function Order({ closeHour }) {
  return (
    <div className="order">
      <p>
        We are currently open till {closeHour}:00. Come visit us or Order online
      </p>
...
function ClosedMessage({ openHour, closeHour }) {
  return (
    <div className="order">
      <p>
        {" "}
  ...
  return (
    <footer className="footer">
      {isOpen ? (
        ...
        <ClosedMessage closeHour={closeHour} openHour={openHour} />
      )}
    </footer>
  );
}
